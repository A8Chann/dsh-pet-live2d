...
// Reach the core model through the Pixi stage: find the Live2DModel instance.
console.log('probe:', await ev(`(() => {
  // The controller exposes groups(); the model itself is on the Pixi stage.
  const app = window.__dshLive2dPetApp
  return app ? 'app-found' : 'need-hook'
})()`))
